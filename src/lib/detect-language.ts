...
async function detectWithModel(text: string, model: ReturnType<AiGateway['chat']>): Promise<LanguageDetectionResult> {
...
export async function detectLanguage(text: string, model: ReturnType<AiGateway['chat']>): Promise<LanguageDetectionResult> {
...
export async function detectLanguageCandidates(text: string, model: ReturnType<AiGateway['chat']>): Promise<LanguageDetectionResult[]> {
